...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, CarDistance> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, CarDistance> kafkaTemplate(ProducerFactory<String, CarDistance> producerFactory) {
